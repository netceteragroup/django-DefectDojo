...
def globalize_vars(request):
    ...
    return {
        ...
        "SOCIAL_AUTH_KEYCLOAK_OAUTH2_GET_GROUPS": settings.SOCIAL_AUTH_KEYCLOAK_OAUTH2_GET_GROUPS,
        "SOCIAL_AUTH_KEYCLOAK_OAUTH2_GROUPS_FILTER": settings.SOCIAL_AUTH_KEYCLOAK_OAUTH2_GROUPS_FILTER,
        "SOCIAL_AUTH_KEYCLOAK_OAUTH2_CLEANUP_GROUPS": settings.SOCIAL_AUTH_KEYCLOAK_OAUTH2_CLEANUP_GROUPS,
