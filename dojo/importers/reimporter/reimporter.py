    ...
    def process_parsed_findings(
        ...
        **kwargs,
        ...
        for index, reimported_finding in enumerate(reimported_findings):
            ...
            if reimported_finding.mitigated and not reimported_finding.mitigated.tzinfo:
                reimported_finding.mitigated = reimported_finding.mitigated.replace(tzinfo=now.tzinfo)
