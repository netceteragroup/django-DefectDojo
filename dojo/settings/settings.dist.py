...
SOCIAL_AUTH_KEYCLOAK_OAUTH2_GET_GROUPS = env("DD_SOCIAL_AUTH_KEYCLOAK_OAUTH2_GET_GROUPS")
SOCIAL_AUTH_KEYCLOAK_OAUTH2_CLEANUP_GROUPS = env("DD_SOCIAL_AUTH_KEYCLOAK_OAUTH2_CLEANUP_GROUPS")
SOCIAL_AUTH_KEYCLOAK_OAUTH2_GROUPS_FILTER = env("DD_SOCIAL_AUTH_KEYCLOAK_OAUTH2_GROUPS_FILTER")
